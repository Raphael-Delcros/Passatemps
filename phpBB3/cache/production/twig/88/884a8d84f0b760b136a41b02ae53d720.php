...
/* overall_header.html */
class __TwigTemplate_c6c624476703ef34d9adefc4234e7929 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        $this->env->setNamespaceLookUpOrder(array('phpbbservices_scsscompiler', '__main__'));
        $this->env->loadTemplate('@phpbbservices_scsscompiler/event/acp_overall_header_stylesheets_after.html')->display($context);

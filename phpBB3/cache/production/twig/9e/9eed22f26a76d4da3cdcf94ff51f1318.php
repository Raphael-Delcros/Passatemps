...
/* search_body.html */
class __TwigTemplate_7d58d3557464a54296cd0ee8adfe5234 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t<dt><label for=\"keywords\">";
        // line 16
        echo ($this->extensions['phpbb\template\twig\extension']->lang("SEARCH_KEYWORDS") . $this->extensions['phpbb\template\twig\extension']->lang("COLON"));
        echo "</label><br /><span>";
...
\t\t<dt><label for=\"author\">";
        // line 22
        echo ($this->extensions['phpbb\template\twig\extension']->lang("SEARCH_AUTHOR") . $this->extensions['phpbb\template\twig\extension']->lang("COLON"));
        echo "</label><br /><span>";
...
\t\t<dt><label for=\"search_forum\">";
        // line 41
        echo ($this->extensions['phpbb\template\twig\extension']->lang("SEARCH_FORUMS") . $this->extensions['phpbb\template\twig\extension']->lang("COLON"));
        echo "</label><br /><span>";
...
\t\t<dt><label for=\"search_child1\">";
        // line 45
        echo ($this->extensions['phpbb\template\twig\extension']->lang("SEARCH_SUBFORUMS") . $this->extensions['phpbb\template\twig\extension']->lang("COLON"));
        echo "</label></dt>
\t\t<dd>
...
\t\t<dt><label for=\"sf1\">";
        // line 52
        echo ($this->extensions['phpbb\template\twig\extension']->lang("SEARCH_WITHIN") . $this->extensions['phpbb\template\twig\extension']->lang("COLON"));
        echo "</label></dt>
...
\t\t<dt><label for=\"show_results1\">";
        // line 64
        echo ($this->extensions['phpbb\template\twig\extension']->lang("DISPLAY_RESULTS") . $this->extensions['phpbb\template\twig\extension']->lang("COLON"));
        echo "</label></dt>
\t\t<dd>
...
\t\t<dt><label for=\"sd\">";
        // line 71
        echo ($this->extensions['phpbb\template\twig\extension']->lang("RESULT_SORT") . $this->extensions['phpbb\template\twig\extension']->lang("COLON"));
        echo "</label></dt>
\t\t<dd>";
        // line 72
...
\t\t<dt><label>";
        // line 78
        echo ($this->extensions['phpbb\template\twig\extension']->lang("RESULT_DAYS") . $this->extensions['phpbb\template\twig\extension']->lang("COLON"));
        echo "</label></dt>
\t\t<dd>";
        // line 79
...
";
    ...
    {
        return array (  365 => 139,  362 => 138,  361 => 137,  353 => 131,  344 => 128,  341 => 127,  333 => 124,  327 => 123,  318 => 122,  313 => 121,  306 => 117,  298 => 111,  296 => 110,  295 => 109,  292 => 108,  291 => 107,  281 => 100,  277 => 99,  267 => 91,  266 => 90,  263 => 89,  262 => 88,  253 => 86,  248 => 84,  244 => 83,  237 => 79,  233 => 78,  226 => 74,  222 => 73,  218 => 72,  214 => 71,  207 => 67,  203 => 66,  198 => 64,  195 => 63,  194 => 62,  189 => 59,  188 => 58,  183 => 56,  179 => 55,  175 => 54,  171 => 53,  167 => 52,  160 => 48,  156 => 47,  151 => 45,  143 => 42,  137 => 41,  134 => 40,  133 => 39,  130 => 38,  129 => 37,  124 => 35,  115 => 28,  114 => 27,  111 => 26,  110 => 25,  105 => 23,  99 => 22,  93 => 19,  89 => 18,  85 => 17,  79 => 16,  76 => 15,  75 => 14,  72 => 13,  71 => 12,  66 => 10,  58 => 6,  57 => 5,  52 => 3,  49 => 2,  37 => 1,);
    }

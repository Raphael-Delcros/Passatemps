...
class phpbb_cache_container extends \Symfony\Component\DependencyInjection\Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = [
            ...
            'phpbbservices.scsscompiler.controller.acp' => 'getPhpbbservices_Scsscompiler_Controller_AcpService',
            'phpbbservices.scsscompiler.listener' => 'getPhpbbservices_Scsscompiler_ListenerService',
        ...
        $this->privates = [
            ...
            'phpbbservices.scsscompiler.controller.acp' => true,
            'phpbbservices.scsscompiler.listener' => true,
            'plupload' => true,
            'posting.lock' => true,
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addListener('core.user_setup', [0 => function () {
            return ${($_ = isset($this->services['phpbbservices.scsscompiler.listener']) ? $this->services['phpbbservices.scsscompiler.listener'] : $this->getPhpbbservices_Scsscompiler_ListenerService()) && false ?: '_'};
    ...
    /**
     * Gets the private 'phpbbservices.scsscompiler.controller.acp' shared service.
     *
     * @return \phpbbservices\scsscompiler\controller\acp_controller
     */
    protected function getPhpbbservices_Scsscompiler_Controller_AcpService()
    {
        return $this->services['phpbbservices.scsscompiler.controller.acp'] = new \phpbbservices\scsscompiler\controller\acp_controller(${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['log']) ? $this->services['log'] : $this->getLogService()) && false ?: '_'}, ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, ${($_ = isset($this->services['template']) ? $this->services['template'] : $this->getTemplateService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './../', ${($_ = isset($this->services['filesystem']) ? $this->services['filesystem'] : ($this->services['filesystem'] = new \phpbb\filesystem\filesystem())) && false ?: '_'});
    }

    /**
     * Gets the private 'phpbbservices.scsscompiler.listener' shared service.
     *
     * @return \phpbbservices\scsscompiler\event\main_listener
     */
    protected function getPhpbbservices_Scsscompiler_ListenerService()
    {
        return $this->services['phpbbservices.scsscompiler.listener'] = new \phpbbservices\scsscompiler\event\main_listener(${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'});
    }
